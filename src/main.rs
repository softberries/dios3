...
fn LeftSidebar() -> Element {
    ...
    ul { class: "mt-6",
        ...
        ul {
        li { class: "relative px-6 py-3",
            Link { to: Route::Forms {}, class: "inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200",
                svg {
...
fn Cards() -> Element {
    ...
    use_coroutine({
        ...
        move |_: dioxus::prelude::UnboundedReceiver<uint32x2_t>| async move {
